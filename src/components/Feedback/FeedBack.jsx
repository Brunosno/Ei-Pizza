...
export default function FeedBack(){
    return(
        <div id="Feedbacks" className="z-50 min-w-full h-screen font-bold flex flex-col items-center">
            <h1 className="z-30 text-white text-4xl md:text-7xl text-center pt-[100px] mb-[20px]">
                Nossos Clientes Dizem:
            </h1>


            <div className="z-30 w-[90%] h-full flex flex-col md:flex-row justify-center items-center gap-10 mt-10">  
                <FeedBackCard/>  
                <FeedBackCard/>
